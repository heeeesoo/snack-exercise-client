...
export function MiissionButton({
    ...
    return(
        <button onClick={onClick} className="w-full p-6 bg-white border border-gray-200 rounded-[16px] shadow ">
            ...
            {
                onClick &&
                <div className="inline-flex justify-center w-[100px] items-center px-3 py-2 text-sm font-medium text-center text-white rounded-[12px] bg-SystemBrand hover:bg-SystemHoverBlue focus:ring-4 focus:outline-none focus:ring-blue-300">
                    시작하기
